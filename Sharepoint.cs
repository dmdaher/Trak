        ...
        public string createProjectReport(string listTitle)
        {
            try
            {
                ...
                try
                {
                    ...
                    fullReport += "Here is all the data for this project: " + Environment.NewLine +
                        "Estimated Start Time: " + estimatedStartTime + "<br>" + 
                        "Estimated End Time: " + estimatedEndTime + "<br>" +
                        "Estimated Start Date: " + estimatedStartDate + "<br>" +
                        "Estimated End Date: " + estimatedEndDate + "<br>" +
                        "Time Spent: " + timeSpent + "<br>" + 
                        "Resources: " + resources + "<br>" +
                        "Current Status: " + currentStatus + "<br>" + 
                        "Current Status Reason: " + currentStatusReason + "<br>" + "<br>" + "And here are the milestones and comments: <br> ";
                    foreach (var milestone in milestoneNumAndComment.OrderBy(i => i.Key))
                    {
                        fullReport += milestone.Key + " : " + milestone.Value + "<br>";
                    }
                    return fullReport;
                }
